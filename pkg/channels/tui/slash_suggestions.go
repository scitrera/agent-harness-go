...
var slashSubcommands = map[string][]selectionItem{
	...
	"refinements": {
		{Value: "--help", Label: "--help", Description: "Show audit filters and cursor usage"},
		{Value: "--attention", Label: "--attention", Description: "Show failed or partial applications"},
		{Value: "--phase", Label: "--phase", Description: "Filter audit phase"},
		{Value: "--outcome", Label: "--outcome", Description: "Filter immutable outcome"},
		{Value: "--scope", Label: "--scope", Description: "Filter refinement scope"},
		{Value: "--resource", Label: "--resource", Description: "Filter edited resource kind"},
		{Value: "--refinement", Label: "--refinement", Description: "Inspect one refinement lineage"},
		{Value: "--search", Label: "--search", Description: "Search bounded audit text"},
		{Value: "--limit", Label: "--limit", Description: "Set page size"},
		{Value: "--cursor", Label: "--cursor", Description: "Continue with opaque cursor"},
	},
	"thread": {
